import { a, c as l } from "@nf-internal/chunk-JYXTBF5A";
import { f as d, k as b } from "@nf-internal/chunk-STIBVO4O";
import * as n from "@angular/core";
import { inject as c, NgZone as m, ElementRef as _, EventEmitter as p, booleanAttribute as g } from "@angular/core";
...
var v = (() => { class t {
    ...
    _mutationObserverFactory = c(v);
    _observedElements = new Map;
    _ngZone = c(m);
    constructor() { }
    ngOnDestroy() { this._observedElements.forEach((e, s) => this._cleanupObserver(s)); }
    observe(e) { let s = l(e); return new d(i => { let f = this._observeElement(s).pipe(E(o => o.filter(h => !D(h))), y(o => !!o.length)).subscribe(o => { this._ngZone.run(() => { i.next(o); }); }); return () => { f.unsubscribe(), this._unobserveElement(s); }; }); }
    _observeElement(e) { return this._ngZone.runOutsideAngular(() => { if (this._observedElements.has(e))
        ...
        let s = new b, i = this._mutationObserverFactory.create(u => s.next(u));
    ...
    set debounce(e) { this._debounce = a(e), this._subscribe(); }
    _debounce;
    ...
    static \u0275fac = function (s) { return new (s || t); };
    static \u0275dir = n.\u0275\u0275defineDirective({ type: t, selectors: [["", "cdkObserveContent", ""]], inputs: { disabled: [2, "cdkObserveContentDisabled", "disabled", g], debounce: "debounce" }, outputs: { event: "cdkObserveContent" }, exportAs: ["cdkObserveContent"] });
} return t; })(), R = (() => { class t {
    static \u0275fac = function (s) { return new (s || t); };
    static \u0275mod = n.\u0275\u0275defineNgModule({ type: t });
    static \u0275inj = n.\u0275\u0275defineInjector({ providers: [v] });
} return t; })();
export { v as a, M as b, A as c, R as d };
