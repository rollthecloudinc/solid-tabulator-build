import { a as ot } from "@nf-internal/chunk-HR77KNDT";
import { a as A } from "@nf-internal/chunk-VJMH5IEE";
import { g as y, i as w } from "@nf-internal/chunk-KQGCPFC3";
import { b as ye, f as ae, k as be, l as G, z as f } from "@nf-internal/chunk-STIBVO4O";
import { a as g, b as P, f as at } from "@nf-internal/chunk-FJYW2LMB";
import * as k from "@angular/common";
import { isPlatformServer as oe, CommonModule as lt } from "@angular/common";
import * as s from "@angular/core";
import { forwardRef as Se, InjectionToken as _e, PLATFORM_ID as ct } from "@angular/core";
import * as $ from "@ngrx/data";
import { DefaultPluralizer as pt, Pluralizer as ut } from "@ngrx/data";
import * as v from "@angular/forms";
import { NG_VALUE_ACCESSOR as dt, NG_VALIDATORS as ft, UntypedFormControl as b, Validators as L, UntypedFormArray as mt, FormsModule as ht, ReactiveFormsModule as gt } from "@angular/forms";
import { map as d, switchMap as m, filter as Te, defaultIfEmpty as le, catchError as ke, concatMap as vt, tap as x, take as K } from "rxjs/operators";
...
import { InteractionsFormPayload as Pt } from "@rollthecloudinc/detour";
import * as O from "@rollthecloudinc/datasource";
import { Datasource as fe, Dataset as me, DatasourceModule as yt } from "@rollthecloudinc/datasource";
import * as te from "@rollthecloudinc/content";
import { ContentPluginEditorOptions as he, ContentBinding as bt, ContentPlugin as ge, CONTENT_PLUGIN as ce } from "@rollthecloudinc/content";
import * as Ae from "@angular/material/autocomplete";
import * as Ee from "@angular/material/input";
import * as Ne from "@angular/material/select";
import * as Re from "@rollthecloudinc/utils";
import { SITE_NAME as Be, NoopDataService as St } from "@rollthecloudinc/utils";
import { MaterialModule as wt } from "@rollthecloudinc/material";
var Pe = at(ot(), 1);
...
import { BridgeBuilderPlugin as xt, PublicApiBridgeService as Ct } from "@rollthecloudinc/bridge";
import * as se from "@rollthecloudinc/crud";
import { CrudAdaptorPlugin as qn, CrudDataService as pe, CrudModule as jt } from "@rollthecloudinc/crud";
import * as ve from "@rollthecloudinc/rules";
import * as Mt from "cssjson";
import { Aws3Module as Dt } from "@rollthecloudinc/aws3";
...
import { createEffect as _t, ofType as Tt, EffectsModule as kt } from "@ngrx/effects";
import * as Ve from "@ngrx/store";
import { createAction as R, props as B, createReducer as Ot, on as J, StoreModule as zt, createFeatureSelector as At, createSelector as z, select as U } from "@ngrx/store";
import * as qe from "@rollthecloudinc/snippet";
import * as Je from "@rollthecloudinc/plugin";
import { BasePluginManager as Et, PluginDef as Nt, Plugin as Rt } from "@rollthecloudinc/plugin";
import { DataSource as Bt } from "@angular/cdk/collections";
import Gt from "deepmerge-json";
import { pluralize as Lt } from "inflected";
...
function Ht(n, i) { if (n & 1 && (s.\u0275\u0275elementStart(0, "mat-form-field")(1, "mat-select", 3), s.\u0275\u0275template(2, Ut, 2, 2, "mat-option", 4), s.\u0275\u0275pipe(3, "async"), s.\u0275\u0275elementEnd()()), n & 2) {
...
function qt(n, i) { if (n & 1 && (s.\u0275\u0275elementStart(0, "mat-form-field")(1, "mat-select", 6), s.\u0275\u0275template(2, Vt, 2, 2, "mat-option", 4), s.\u0275\u0275pipe(3, "async"), s.\u0275\u0275elementEnd()()), n & 2) {
    let e = s.\u0275\u0275nextContext();
...
function Kt(n, i) { if (n & 1 && (s.\u0275\u0275elementStart(0, "mat-form-field")(1, "mat-select", 7), s.\u0275\u0275template(2, Jt, 2, 2, "mat-option", 4), s.\u0275\u0275pipe(3, "async"), s.\u0275\u0275elementEnd()()), n & 2) {
    let e = s.\u0275\u0275nextContext();
    s.\u0275\u0275advance(2), s.\u0275\u0275property("ngForOf", s.\u0275\u0275pipeBind1(3, 1, e.panes$));
} }
function Yt(n, i) { if (n & 1 && s.\u0275\u0275element(0, "druid-panels-panelpage-linkedlist", 8), n & 2) {
    let e = s.\u0275\u0275nextContext();
    s.\u0275\u0275property("panelPages", e.nested);
} }
function Qt(n, i) { if (n & 1) {
...
function Wt(n, i) { if (n & 1 && (s.\u0275\u0275elementStart(0, "mat-nav-list"), s.\u0275\u0275template(1, Qt, 3, 2, "a", 5), s.\u0275\u0275pipe(2, "async"), s.\u0275\u0275elementEnd()), n & 2) {
    let e = s.\u0275\u0275nextContext();
    s.\u0275\u0275advance(), s.\u0275\u0275property("ngForOf", s.\u0275\u0275pipeBind1(2, 1, e.panels$));
} }
var Xt = (n, i) => ({ PanelPageListItem: { entityName: "PanelPageListItem", crud: P(g({}, oe(n) ? {} : { idb_keyval: { params: { prefix: "panelpage__" }, queryMappings: new Map([["site", { defaultOperator: "term||wildcard" }], ["path", { defaultOperator: "term||wildcard" }]]) } }), { idb_keyval: { params: { prefix: "panelpage__" }, queryMappings: new Map([["site", { defaultOperator: "term||wildcard" }], ["path", { defaultOperator: "term||wildcard" }]]) } }) }, PanelPage: { entityName: "PanelPage", crud: g({ save: { ops: ["create", "update"], plugin: "rest", params: { entityName: "PanelPage" } }, readPrimary: { fallback: !0, ops: ["create", "update", "query"], plugin: oe(n) ? "memory_store" : "idb_keyval", params: { prefix: "panelpage__" } }, readFallback: { fallback: !0, ops: ["query"], plugin: "rest", params: { entityName: "PanelPage", root: i.objectsRootUrl, suffix: ".json" } } }, oe(n) ? {} : { idb_keyval: { params: { prefix: "panelpage__" } } }) }, PanelPageState: { entityName: "PanelPageState" } }), we = class {
    ...
    constructor(i) { this.panels = [], i && (this.id = i.id, this.name = i.name, this.title = i.title, this.derivativeId = i.derivativeId, this.valid = !!i.valid, i.persistence && (this.persistence = new ze(i.persistence)), i.panels && (this.panels = i.panels.map(e => new W(e)))); }
}, W = class {
    ...
    fetchDynamicData(e, t) { return f(new me); }
    ...
    editorOptions(e) { return f(new he); }
    ...
    constructor(e, t) { this.fb = e, this.panelHandler = t, this.panelPages$ = new G([]), this.panels$ = new G([]), this.panes$ = new G([]), this.nested$ = new G([]), this.formGroup = this.fb.group({ panelPage: this.fb.control(void 0), panel: this.fb.control(void 0), pane: this.fb.control(void 0), nested: this.fb.control(void 0) }), this.panelPageSub = this.formGroup.get("panelPage").valueChanges.subscribe(r => { this.panels$.next(new I(this.panelPages$.value[r]).panels); }), this.panelSub = this.formGroup.get("panel").valueChanges.subscribe(r => { this.panes$.next(new E(this.panels$.value[r]).panes); }), this.paneSub = this.formGroup.get("pane").valueChanges.pipe(d(r => this.panes$.value[r]), m(r => w(() => r.contentPlugin === "panel", this.panelHandler.toObject(r.settings), f(void 0))), Te(r => !!r)).subscribe(r => { this.nested$.next([r]); }), this.onTouched = () => { }; }
    ...
    static { this.\u0275fac = function (t) { return new (t || n)(s.\u0275\u0275directiveInject(v.UntypedFormBuilder), s.\u0275\u0275directiveInject(F)); }; }
    static { this.\u0275cmp = s.\u0275\u0275defineComponent({ type: n, selectors: [["druid-panels-panelpage-linkedlist"]], inputs: { panelPages: "panelPages", panels: "panels", panes: "panes" }, standalone: !1, features: [s.\u0275\u0275ProvidersFeature([{ provide: dt, useExisting: Se(() => n), multi: !0 }, { provide: ft, useExisting: Se(() => n), multi: !0 }])], decls: 5, vars: 5, consts: [[3, "formGroup"], [4, "ngIf"], ["formControlName", "nested", 3, "panelPages", 4, "ngIf"], ["required", "", "formControlName", "panelPage"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], ["required", "", "formControlName", "panel"], ["required", "", "formControlName", "pane"], ["formControlName", "nested", 3, "panelPages"]], template: function (t, r) { t & 1 && (s.\u0275\u0275elementStart(0, "div", 0), s.\u0275\u0275template(1, Ht, 4, 3, "mat-form-field", 1)(2, qt, 4, 3, "mat-form-field", 1)(3, Kt, 4, 3, "mat-form-field", 1)(4, Yt, 1, 1, "druid-panels-panelpage-linkedlist", 2), s.\u0275\u0275elementEnd()), t & 2 && (s.\u0275\u0275property("formGroup", r.formGroup), s.\u0275\u0275advance(), s.\u0275\u0275property("ngIf", r.panelPages.length > 0), s.\u0275\u0275advance(), s.\u0275\u0275property("ngIf", r.panels.length > 0), s.\u0275\u0275advance(), s.\u0275\u0275property("ngIf", r.panes.length > 0), s.\u0275\u0275advance(), s.\u0275\u0275property("ngIf", r.nested)); }, dependencies: [k.NgForOf, k.NgIf, v.NgControlStatus, v.NgControlStatusGroup, v.RequiredValidator, v.FormGroupDirective, v.FormControlName, Ae.MatOption, Ee.MatFormField, Ne.MatSelect, n, k.AsyncPipe], encapsulation: 2 }); }
} return n; })(), Ke = (() => { class n {
    ...
    convertToGroup(e) { let t = this.fb.group({ name: new b(e.name, L.required), type: new b(e.type, L.required), displayName: new b(e.displayName, L.required), value: new b(e.value, L.required), computedValue: new b(e.value, L.required), attributes: new mt([]) }); return e.attributes && e.attributes.length > 0 && e.attributes.forEach(r => { t.get("attributes").push(this.convertToGroup(r)); }), t; }
    static { this.\u0275fac = function (t) { return new (t || n)(s.\u0275\u0275directiveInject(Be), s.\u0275\u0275directiveInject(Ge.MatBottomSheetRef), s.\u0275\u0275directiveInject(F), s.\u0275\u0275directiveInject(ne.MatDialog), s.\u0275\u0275directiveInject(v.UntypedFormBuilder), s.\u0275\u0275directiveInject($.EntityServices)); }; }
    static { this.\u0275cmp = s.\u0275\u0275defineComponent({ type: n, selectors: [["classifieds-ui-panel-selector"]], inputs: { panelFormGroup: "panelFormGroup" }, standalone: !1, decls: 13, vars: 1, consts: [["mat-align-tabs", "start", 3, "selectedIndex"], ["label", "Type"], ["mat-list-item", "", "mat-list-item", "", 3, "click"], ["label", "Search"], ["matTabContent", ""], ["mat-list-item", "", "mat-list-item", "", 3, "click", 4, "ngFor", "ngForOf"], ["mat-line", ""]], template: function (t, r) { t & 1 && (s.\u0275\u0275elementStart(0, "mat-tab-group", 0)(1, "mat-tab", 1)(2, "mat-nav-list")(3, "a", 2), s.\u0275\u0275listener("click", function () { return r.onNewSelect(); }), s.\u0275\u0275text(4, "New Panel"), s.\u0275\u0275elementEnd(), s.\u0275\u0275elementStart(5, "a", 2), s.\u0275\u0275listener("click", function () { return r.onLinkSelect(); }), s.\u0275\u0275text(6, "Link Panel"), s.\u0275\u0275elementEnd(), s.\u0275\u0275elementStart(7, "a", 2), s.\u0275\u0275listener("click", function () { return r.onEmbedSelect(); }), s.\u0275\u0275text(8, "Embed Panel"), s.\u0275\u0275elementEnd(), s.\u0275\u0275elementStart(9, "a", 2), s.\u0275\u0275listener("click", function () { return r.onYieldSelect(); }), s.\u0275\u0275text(10, "Yield"), s.\u0275\u0275elementEnd()()(), s.\u0275\u0275elementStart(11, "mat-tab", 3), s.\u0275\u0275template(12, Wt, 3, 3, "ng-template", 4), s.\u0275\u0275elementEnd()()), t & 2 && s.\u0275\u0275property("selectedIndex", r.selectedIndex); }, dependencies: [k.NgForOf, Le.MatLine, ie.MatNavList, ie.MatListItem, H.MatTabContent, H.MatTab, H.MatTabGroup, k.AsyncPipe], encapsulation: 2 }); }
} return n; })(), Zt = (() => { class n {
    constructor() { }
    ngOnInit() { }
    ...
    isData(e) { return !0; }
    fetchDynamicData(e, t) { let r = t.has("dataPanes") ? new Map(t.get("dataPanes").map(o => [o.name, o])) : new Map([]), a = new Map(Array.from(r).map(([o, l]) => [o, new fe(this.attributeSerializer.deserializeAsObject(l.settings))])); return this.toObject(e).pipe(m(o => this.datasourceEvalutator.evalDatasource({ datasource: o, metadata: t, datasources: a }))); }
    buildDynamicItems(e, t) { let r = new Map(t.get("dataPanes").map(a => [a.name, a])); return this.fetchDynamicData(e, t).pipe(m(a => this.toObject(e).pipe(d(o => [o, a]))), m(([a, o]) => this.getBindings(e, "pane").pipe(d(l => [a, o, l]))), m(([a, o, l]) => w(() => o.results.length !== 0 && l.length > 0, y(o.results.map(p => y(l.filter(c => !r.has(c.id)).map(c => f(t.get("panes").find(u => u.name === c.id)).pipe(m(u => w(() => u && u.rule && u.rule !== null && u.rule.condition !== "", u ? this.rulesResolver.evaluate(u.rule, [...t.get("contexts"), ...u.contexts !== void 0 ? u.contexts : [], new Y({ name: "_root", adaptor: "data", data: p })]).pipe(d(h => [u, h])) : f([u, !1]), f(!1).pipe(d(h => [u, h])))), Te(([u, h]) => h), d(([u, h]) => u.name), le(c.id)))).pipe(d(c => c.reduce((u, h) => [...u, h], []))))).pipe(d(p => [a, o, p])), new ae(p => { p.next([a, o, []]), p.complete(); }))), d(([a, o, l]) => o.results.reduce((p, c, u) => [...p, ...l[u] ? l[u].map(h => new _(P(g({}, t.get("panes").find(S => S.name === h)), { rule: void 0, label: A(), contexts: [...t.get("contexts"), new Y({ name: "_root", adaptor: "data", data: c })] }))) : []], [])), d(a => new E({ stylePlugin: void 0, settings: [], panes: a, columnSetting: new j })), d(a => this.panelHandler.buildSettings(new I({ id: void 0, layoutType: "grid", displayType: "page", site: this.siteName, gridItems: [], layoutSetting: new j, rowSettings: [], panels: [a] }))), d(a => a.find(o => o.name === "panels").attributes[0].attributes.find(o => o.name === "panes").attributes)); }
    getBindings(e, t, r) { let a = r ? new Map(r.get("dataPanes").map(o => [o.name, o])) : new Map; return t === "context" ? this.toObject(e).pipe(d(o => [o, o.params ? o.params.reduce((l, p) => [...l, ...p.mapping.type === "form" ? [new bt({ id: `form__${p.mapping.value.split(".", 2)[0].trim()}`, type: "context" })] : []], []) : []]), m(([o, l]) => this.dpm.getPlugin(o.plugin).pipe(m(p => p.getBindings({ settings: o.settings, metadata: r }).pipe(d(c => [o, c]))))), m(([o, l]) => y(o.renderer.bindings.reduce((p, c) => [...p, ...a.has(c.id) ? [this.toObject(a.get(c.id).settings)] : []], [])).pipe(m(p => y(p.map(c => this.dpm.getPlugin(c.plugin).pipe(m(u => u.getBindings({ settings: c.settings, metadata: r }))))).pipe(d(c => c.reduce((u, h) => [...u, ...h], l)), le(l))), le(l)))) : this.toObject(e).pipe(m(o => w(() => o.renderer.type === t, f(o.renderer.bindings), f([])))); }
    toObject(e) { return f(this.attributeSerializer.deserializeAsObject(e)); }
    buildSettings(e) { return this.attributeSerializer.serialize(e, "root").attributes; }
    ...
    editorOptions(e) { return this.toObject(e).pipe(m(t => this.dpm.getPlugin(t && t.plugin ? t.plugin : "data").pipe(d(r => [t, r]))), m(([t, r]) => r.editorOptions ? r.editorOptions({ settings: t && t.settings ? t.settings : [] }) : f(void 0)), d(t => new he({ fullscreen: t ? t.fullscreen : !1 }))); }
    static { this.\u0275fac = function (t) { return new (t || n)(s.\u0275\u0275inject(Be), s.\u0275\u0275inject(F), s.\u0275\u0275inject(M.AttributeSerializerService), s.\u0275\u0275inject(ve.RulesResolverService), s.\u0275\u0275inject(O.DatasourcePluginManager), s.\u0275\u0275inject(O.DatasourceEvaluator)); }; }
    static { this.\u0275prov = s.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), en = (() => { class n {
    ...
    static { this.\u0275fac = function (t) { return new (t || n)(s.\u0275\u0275directiveInject(It), s.\u0275\u0275directiveInject(ne.MatDialogRef), s.\u0275\u0275directiveInject(v.UntypedFormBuilder), s.\u0275\u0275directiveInject(M.AttributeSerializerService), s.\u0275\u0275directiveInject(Ye)); }; }
...
} return n; })(), tn = n => new ge({ id: "panel", title: "Panel", selectionComponent: Ke, editorComponent: Zt, renderComponent: void 0, handler: n }), nn = ({ handler: n }) => new ge({ id: "yield", title: "Yield", selectionComponent: Ke, editorComponent: void 0, renderComponent: void 0, handler: n }), sn = n => new ge({ id: "datasource", title: "Datasource", selectionComponent: void 0, editorComponent: en, renderComponent: void 0, handler: n }), rn = (n, i) => new xt({ id: "panels", title: "Panels", build: () => { Ct.prototype.writePaneState = (e, t) => new Promise(r => { let a = n.getEntityCollectionService("PanelPageState"); a.getByKey(e.id).pipe(ke(() => f(new C({ id: e.id, panels: [] }))), d(o => o === void 0 ? new C({ id: e.id, panels: [] }) : o), d(o => { let l = i.serialize(t, "root"), p = new C(P(g({}, o), { panels: [] })); for (let c = 0; c < e.panelIndex + 1; c++) {
        p.panels.push(c < o.panels.length ? new T(P(g({}, o.panels[c]), { panes: [] })) : new T);
        for (let u = 0; u < e.paneIndex + 1; u++)
            c === e.panelIndex && u === e.paneIndex ? p.panels[c].panes.push(c < o.panels.length && u < o.panels[c].panes.length ? new D(P(g({}, o.panels[c].panes[u]), { state: l })) : new D({ state: l })) : p.panels[c].panes.push(c < o.panels.length && u < o.panels[c].panes.length ? new D(g({}, o.panels[c].panes[u])) : new D);
    } return p; }), m(o => a.upsert(o))).subscribe(o => { r(o); }); }); } });
var Qe = R("[PageBuilder] Load Rest Data", B()), We = R("[PageBuilder] Load Rest Data Success", B()), ii = R("[PageBuilder] Load Rest Data Error", B()), Xe = R("[PageBuilder] Set Page Info", B()), Ze = R("[PageBuilder] Set Form", B()), et = R("[PageBuilder] Set Page", B()), tt = R("[PageBuilder] Selection Path", B()), an = (() => { class n {
    ...
    constructor(e, t, r) { this.actions$ = e, this.datasourceApi = t, this.snippetParserService = r, this.loadRestData$ = _t(() => this.actions$.pipe(Tt(Qe), vt(a => this.fetchRestdata$(a.rest).pipe(ke(() => []), d(o => a.rest.renderer !== void 0 && a.rest.renderer.query !== void 0 && a.rest.renderer.query !== "" ? Pe.JSONPath({ path: a.rest.renderer.query, json: o }) : o), d(o => We({ tag: a.tag, data: new me({ results: o }) })))))); }
...
}, nt = "pageBuilder", on = { dataTags: [], datasets: [], pageInfo: void 0, formNames: [], forms: [], page: void 0, selectionPath: [] }, ln = Ot(on, J(We, (n, i) => { let e = n.dataTags.findIndex(t => t === i.tag); if (e > -1 && n.forms[e] !== void 0) {
    let t = g({}, n);
    return t.datasets[e].push(i.data), t;
}
else
    return P(g({}, n), { dataTags: [...n.dataTags, i.tag], datasets: [...n.datasets, [i.data]] }); }), J(Ze, (n, i) => { let e = n.formNames.findIndex(t => t === i.name); return e > -1 && n.forms[e] !== void 0 ? P(g({}, n), { forms: n.forms.map((t, r) => r === e ? i.form : t) }) : P(g({}, n), { formNames: [...n.formNames, i.name], forms: [...n.forms, i.form] }); }), J(Xe, (n, i) => P(g({}, n), { pageInfo: i.info !== void 0 ? new de(i.info) : void 0 })), J(et, (n, i) => P(g({}, n), { page: i.page !== void 0 ? new I(i.page) : void 0 })), J(tt, (n, i) => P(g({}, n), { selectionPath: i.path !== void 0 ? i.path : [] })));
function cn(n, i) { return ln(n, i); }
var si = new _e("StylePlugin"), pn = new _e("PanelsSettings"), un = (() => { class n {
    constructor(e) { this.attributeSerializer = e; }
    handleFile(e) { return f(); }
    handlesType(e) { return !1; }
    implementsRendererOverride() { return !1; }
    ...
    constructor(e, t, r, a, o, l, p, c, u, h, S, q, re) { let st = Xt(e, r); a.registerMetadataMap(st), l.registerService("PanelPageState", new St("PanelPageState")), l.registerService("PanelPage", new pe("PanelPage", h, S, q)), l.registerService("PanelPageListItem", new pe("PanelPageListItem", h, S, q)), t.forEach(rt => o.register(rt)), o.register(nn({ handler: re })), p.register(rn(c, u)), l.registerService("PanelPageForm", new pe("PanelPageForm", h, S, q)); }
    static { this.\u0275fac = function (t) { return new (t || n)(s.\u0275\u0275inject(ct), s.\u0275\u0275inject(ce), s.\u0275\u0275inject(pn), s.\u0275\u0275inject($.EntityDefinitionService), s.\u0275\u0275inject(te.ContentPluginManager), s.\u0275\u0275inject($.EntityDataService), s.\u0275\u0275inject(Ue.BridgeBuilderPluginManager), s.\u0275\u0275inject($.EntityServices), s.\u0275\u0275inject(M.AttributeSerializerService), s.\u0275\u0275inject(se.CrudAdaptorPluginManager), s.\u0275\u0275inject($.EntityDefinitionService), s.\u0275\u0275inject(se.CrudDataHelperService), s.\u0275\u0275inject(un)); }; }
    static { this.\u0275mod = s.\u0275\u0275defineNgModule({ type: n }); }
    static { this.\u0275inj = s.\u0275\u0275defineInjector({ providers: [{ provide: F, useClass: F }, { provide: ce, useFactory: tn, multi: !0, deps: [F] }, { provide: ce, useFactory: sn, multi: !0, deps: [Ye] }, { provide: ut, useClass: pt }], imports: [lt, ht, gt, zt.forFeature(nt, cn), kt.forFeature([an]), wt, yt, $t, Dt, Ft, jt] }); }
} return n; })(), Fe = class n {
    ...
    static { this.\u0275fac = function (t) { return new (t || n)(s.\u0275\u0275inject($.EntityServices), s.\u0275\u0275inject(F)); }; }
    static { this.\u0275prov = s.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), ci = (() => { class n {
    ...
    static { this.\u0275fac = function (t) { return new (t || n)(s.\u0275\u0275inject(F)); }; }
    static { this.\u0275prov = s.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), pi = (() => { class n {
    constructor(e) { this.panelHandler = e; }
    ...
    } p.length === 0 ? (o.next(r), o.complete()) : y(p).pipe(d(c => c.reduce((u, h) => [...u, ...h], r)), x(c => { o.next(c), o.complete(); })).subscribe(); }); }
    ...
    static { this.\u0275fac = function (t) { return new (t || n)(s.\u0275\u0275inject(fn), s.\u0275\u0275inject(te.ContentPluginManager)); }; }
    static { this.\u0275prov = s.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), mn = (() => { class n {
    constructor(e) { this.attributeSerializer = e; }
    ...
    static { this.\u0275fac = function (t) { return new (t || n); }; }
    static { this.\u0275prov = s.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), hn = (() => { class n extends Et {
    constructor(e, t) { super(e, t); }
    pluginDef() { return f(new Nt({ name: "style" })); }
    static { this.\u0275fac = function (t) { return new (t || n)(s.\u0275\u0275inject(Je.PluginConfigurationManager), s.\u0275\u0275inject(Re.ModuleLoaderService)); }; }
    static { this.\u0275prov = s.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), fi = (() => { class n {
    ...
    static { this.\u0275fac = function (t) { return new (t || n)(s.\u0275\u0275inject(hn)); }; }
    static { this.\u0275prov = s.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), mi = (() => { class n {
    constructor(e, t, r, a) { this.panelHandler = e, this.rulesResolver = t, this.inlineContextResolver = r, this.cpm = a; }
    usedContexts(e) { return this.panesPlugins(e).pipe(m(t => this.dataPanes(e).pipe(d(r => ({ plugins: t, dataPanes: r })))), m(({ plugins: t, dataPanes: r }) => y(e.reduce((a, o) => { let l = t.get(o.contentPlugin); return l.handler !== void 0 ? [...a, l.handler.getBindings(o.settings, "context", new Map([["dataPanes", r]])).pipe(d(p => p.map(c => c.id)))] : [...a]; }, [])).pipe(d(a => a.reduce((o, l) => [...o, ...l], []))))); }
    ...
    resolvePanes({ panes: e, contexts: t, resolvedContext: r }) { return console.log("resolve panes"), this.panesPlugins(e).pipe(m(a => y(e.reduce((o, l) => { let p = a.get(l.contentPlugin); return p.handler !== void 0 ? [...o, p.handler.getBindings(l.settings, "pane").pipe(d(c => c.map(u => u.id)))] : [...o, f([])]; }, [])))).pipe(d(a => a.reduce((o, l) => [...o, ...l], [])), m(a => this.panesPlugins(e).pipe(d(o => [a, o]))), m(([a, o]) => y(e.reduce((l, p) => { let c = o.get(p.contentPlugin); return c.handler !== void 0 && c.handler.isDynamic(p.settings) ? [...l, c.handler.isData(p.settings) && a.findIndex(u => u === p.name) !== -1 ? f([]) : y([this.staticPanes(e), this.dataPanes(e)]).pipe(m(([u, h]) => c.handler.buildDynamicItems(p.settings, new Map([...p.metadata === void 0 ? [] : p.metadata, ["tag", A()], ["panes", u], ["dataPanes", h], ["contexts", t !== void 0 ? t : []]])).pipe(d(S => this.panelHandler.fromPanes(S)), d(S => this.panelHandler.wrapPanel(S).panes), K(1))))] : p.name === "" || a.findIndex(u => u === p.name) === -1 ? [...l, f([new _(P(g({}, p), { contexts: [...t, ...p.contexts ? p.contexts : []] }))]).pipe(m(u => w(() => u[0].rule !== void 0 && u[0].rule !== null && u[0].rule.condition !== "", this.rulesResolver.evaluate(u[0].rule, [...t, ...p.contexts ? p.contexts : []]).pipe(d(h => h ? u : [])), f(u))))] : [...l]; }, [])).pipe(m(l => w(() => l.reduce((p, c) => [...p, ...c], []).length === 0, f([l, []]), y([...l.reduce((p, c) => [...p, ...c.map(u => u.contexts && u.contexts.length !== 0 ? this.inlineContextResolver.resolveAll(u.contexts).pipe(K(1)) : f({}).pipe(K(1)))], [])]).pipe(d(p => [l, p.map(c => g(g({}, c), r))])))), d(([l, p]) => { let c = [], u = []; return l.forEach((h, S) => { c = [...c === void 0 ? [] : c, ...h.map((q, re) => new _(P(g({}, q), { resolvedContext: p[c.length + re] })))], u = [...u && [], ...h.map(() => S)]; }), { resolvedPanes: c, originMappings: u }; })))); }
    static { this.\u0275fac = function (t) { return new (t || n)(s.\u0275\u0275inject(F), s.\u0275\u0275inject(ve.RulesResolverService), s.\u0275\u0275inject(Oe.InlineContextResolverService), s.\u0275\u0275inject(te.ContentPluginManager)); }; }
    static { this.\u0275prov = s.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), $e = class extends Rt {
...
}, hi = (() => { class n extends Bt {
    constructor() { super(), this.pageChange$ = new be, this.pageSize = 20, this.dataStream = new G([]), this.subscription = new ye, this.lastPage = 0, this.paneItems = []; }
    ...
    static { this.\u0275fac = function (t) { return new (t || n); }; }
    static { this.\u0275prov = s.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac }); }
} return n; })(), V = At(nt), gi = n => z(V, i => { let e = i.dataTags.findIndex(t => t === n); if (e > -1)
    return i.datasets[e][i.datasets[e].length - 1]; }), gn = z(V, n => n.pageInfo), vn = z(V, n => n.page), Pn = z(V, n => n.selectionPath), it = z(V, n => n.formNames), yn = z(V, n => n.forms), bn = z(it, yn, (n, i, e) => { let t = n.findIndex(r => r === e.name); if (t > -1)
    return i[t]; }), Sn = (() => { class n {
    constructor(e) { this.store = e, this.getPageInfo$ = this.store.pipe(U(gn)), this.getPage$ = this.store.pipe(U(vn)), this.getSelectionPath$ = this.store.pipe(U(Pn)), this.getFormNames$ = this.store.pipe(U(it)), this.getForm$ = t => this.store.pipe(U(bn, { name: t })); }
    loadRestData(e, t) { this.store.dispatch(Qe({ tag: e, rest: t })); }
    setPageInfo(e) { this.store.dispatch(Xe({ info: e })); }
    setPage(e) { this.store.dispatch(et({ page: e })); }
    setSelectionPath(e) { this.store.dispatch(tt({ path: e })); }
    setForm(e, t) { this.store.dispatch(Ze({ name: e, form: t })); }
    ...
    mergeState({ state: e, settings: t, plugin: r, ancestory: a }) { return f(e).pipe(m(o => this.pageBuilderFacade.getPageInfo$.pipe(d(l => [o, l]))), m(([o, l]) => r.handler.stateDefinition(t).pipe(d(p => [o, l, p]))), m(([o, l, p]) => this.panelPageStateService.collection$.pipe(U(this.selectById({ id: l.id })), d(c => [o, new C(c || { id: l.id, panels: [] }), p]), K(1))), d(([o, l, p]) => { this.panelStateArchitectService.buildToAncestorySpec({ panelPageState: l, ancestory: [...a] }); let c = "$." + a.map((h, S) => `${(S + 1) % 2 === 0 ? "panes" : (S === 0 ? "" : "nestedPage.") + "panels"}[${h}]`).join("."), u = Pe.JSONPath({ path: c, json: l })[0]; return [o, l, p, u]; }), x(([o, l, p, c]) => { let u = c.state ? c.state.root ? this.attributeSerializer.deserialize(c.state).root : this.attributeSerializer.deserialize(c.state) : {}, h = Gt(!u || Object.keys(u).length === 0 ? p : u, o); c.state = this.attributeSerializer.serialize(h, "root"); }), d(([o, l, p, c]) => ({ paneState: c, pageState: l }))); }
    static { this.\u0275fac = function (t) { return new (t || n)(s.\u0275\u0275inject(Sn), s.\u0275\u0275inject(mn), s.\u0275\u0275inject(M.AttributeSerializerService), s.\u0275\u0275inject($.EntityServices)); }; }
    static { this.\u0275prov = s.\u0275\u0275defineInjectable({ token: n, factory: n.\u0275fac, providedIn: "root" }); }
} return n; })(), Pi = (() => { class n {
    constructor(e) { this.attributeSerializer = e; }
    serializeForm(e) { let t = e.panels.length, r = {}; for (let a = 0; a < t; a++) {
        ...
        for (let p = 0; p < o; p++) {
            ...
            if (e.panels[a].panes[p].name && e.panels[a].panes[p].name !== null && (r[e.panels[a].panes[p].name] || e.panels[a].panes[p].name === Lt(e.panels[a].panes[p].name))) {
...
export { Si as CssHelperService, Ye as DatasourceContentHandler, en as DatasourceEditorComponent, di as DynamicPaneService, Ce as FormDatasource, bi as FormGroupConverterService, Pi as FormService, yi as FormStateConverterService, Z as GridItem, De as GridLayout, ai as LayoutEditorBaseComponent, oi as LayoutRendererBaseComponent, j as LayoutSetting, pn as PANELS_SETTINGS, Sn as PageBuilderFacade, _ as Pane, hi as PaneDatasourceService, xe as PanePropsFormPayload, D as PaneState, vi as PaneStateService, E as Panel, F as PanelContentHandler, Zt as PanelEditorComponent, I as PanelPage, Q as PanelPageForm, X as PanelPageFormPane, W as PanelPageFormPanel, ni as PanelPageLinkedlistComponent, Me as PanelPageListItem, ee as PanelPagePermissions, Fe as PanelPageSelector, C as PanelPageState, de as PanelPageStateSlice, Ie as PanelPropsFormPayload, mi as PanelResolverService, Ke as PanelSelectorComponent, T as PanelState, mn as PanelStateArchitectService, pi as PanelStateConverterService, li as PanelStyleRendererBaseComponent, ui as PanelsContextService, dn as PanelsLoaderService, ri as PanelsModule, ci as PanelsSelectorService, je as PanelsSettings, fn as PanelsWalkerService, ue as PrerenderFormPayload, we as PropertiesFormPayload, si as STYLE_PLUGIN, $e as StylePlugin, hn as StylePluginManager, fi as StyleResolverService, on as initialState, Qe as loadRestData, ii as loadRestDataError, We as loadRestDataSuccess, nt as pageBuilderFeatureKey, cn as reducer, gi as selectDataset, bn as selectForm, it as selectFormNames, yn as selectForms, vn as selectPage, V as selectPageBuilderState, gn as selectPageInfo, Pn as selectSelectionPath, Ze as setForm, et as setPage, Xe as setPageInfo, tt as setSelectionPath };
