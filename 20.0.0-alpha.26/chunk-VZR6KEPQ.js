import { B as S, E as A, F as V, G as Q, I as j, J as z, a as f, b as y, d as M, f as u, h as W, n as x, o as d, q as E, r as C, s as _, t as P, u as R, v as c, y as w } from "@nf-internal/chunk-STIBVO4O";
import { __extends as ir } from "tslib";
import { __read as er, __spreadArray as tr } from "tslib";
var rr = 1, F, I = {};
function U(e) { return e in I ? (delete I[e], !0) : !1; }
var O = { setImmediate: function (e) { var t = rr++; return I[t] = !0, F || (F = Promise.resolve()), F.then(function () { return U(t) && e(); }), t; }, clearImmediate: function (e) { U(e); } };
var or = O.setImmediate, nr = O.clearImmediate, v = { setImmediate: function () { for (var e = [], t = 0; t < arguments.length; t++)
...
function dr(e, t) { var r = typeof t == "object"; return new Promise(function (n, o) { var i = new M({ next: function (m) { n(m), i.unsubscribe(); }, error: o, complete: function () { r ? n(t.defaultValue) : o(new S); } }); e.subscribe(i); }); }
function q(e) { return new u(function (t) { c(e()).subscribe(t); }); }
function hr() { for (var e = [], t = 0; t < arguments.length; t++)
    e[t] = arguments[t]; var r = C(e), n = V(e), o = n.args, i = n.keys, m = new u(function (p) { var a = o.length; if (!a) {
    p.complete();
    return;
} for (var s = new Array(a), l = a, k = a, Z = function (L) { var g = !1; c(o[L]).subscribe(W(p, function ($) { g || (g = !0, k--), s[L] = $; }, function () { return l--; }, void 0, function () { (!l || !g) && (k || p.next(i ? Q(i, s) : s), p.complete()); })); }, b = 0; b < a; b++)
...
function T(e, t, r, n) { if (f(r) && (n = r, r = void 0), n)
    return T(e, t, r).pipe(A(n)); var o = vr(wr(e) ? br.map(function (p) { return function (a) { return e[p](t, a, r); }; }) : yr(e) ? Ar.map(X(e, t)) : Er(e) ? gr.map(X(e, t)) : [], 2), i = o[0], m = o[1]; if (!i && R(e))
    return j(function (p) { return T(p, t, r); })(c(e)); if (!i)
...
function Sr(e, t, r) { return q(function () { return e() ? t : r; }); }
function Fr() { for (var e = [], t = 0; t < arguments.length; t++)
    e[t] = arguments[t]; var r = _(e), n = P(e, 1 / 0), o = e; return o.length ? o.length === 1 ? c(o[0]) : z(n)(w(o, r)) : E; }
export { fr as a, ur as b, lr as c, xr as d, dr as e, q as f, hr as g, T as h, Sr as i, Fr as j };
